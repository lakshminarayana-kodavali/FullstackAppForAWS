pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://44.222.24.244:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/lakshminarayana-kodavali/FullstackAppForAWS.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://44.222.24.244:9090/springapp1"
            echo "✅ Frontend deployed: http://44.222.24.244:9090/frontapp1"
        }
        failure {
